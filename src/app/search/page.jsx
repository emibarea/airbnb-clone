...
export default function Page() {
  ...
  //   const getData = async () => {
  //     try {
  //       const response = await fetch("https://jsonkeeper.com/b/IFPS");
  //       if (!response.ok) {
  ...
  const nbOfGuests = searchParams.get("nbOfGuests");
    ...
    <div>
      ...
      <main className="flex">
        <section className="flex-grow pt-14 px-6">
          ...
          <div className="hidden lg:inline-flex mt-2 mb-5 space-x-3 text-gray-300 whitespace-nowrap">
            <p className="button">Cancelation Flexibility</p>
            <p className="button">Type of Place</p>
            <p className="button">Price</p>
            <p className="button">Rooms and beds</p>
            <p className="button">Moore filters</p>
          </div>
